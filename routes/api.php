...
Route::get('/productsWithOffersInStore/{storeId}', [StoreController::class, 'productsWithOffers']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware(['permission:manage store products'])->group(function () {
        ...
        Route::get('/storeMedia', [StoreController::class, 'indexMedia']);
    ...
    Route::middleware(['permission:manage service catalog'])->group(function () {
        ...
        Route::get('/serviceMedia', [ServiceController::class, 'indexMedia']);
